...
class UserForm(UserCreationForm):
    ...
    username = forms.CharField(label='Введите логин', max_length=16, required=True,
    ...
    password1 = forms.CharField(label='Введите пароль', required=True,
                                help_text='Пароль не должен быть маленьким или простым', widget=forms.PasswordInput(
